...
public class ServicoDadosAluno {
    ...
    public ServicoDadosAluno(RepositorioAluno repositorio) {
        this.repositorio = repositorio;
    }
    
    public ServicoDadosAluno(IRepositorioDados repositorio) {
        this.repositorio = (RepositorioAluno) repositorio;
    }
